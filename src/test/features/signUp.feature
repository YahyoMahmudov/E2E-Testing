Feature: Sign up
        ...
        Scenario: Create a new user
             Then User clicks "Get Started Button" on "Landing Page"
              ...
              And User fills "Phone Number Input" as "+12345678" on "Sign Up Page"
              And User fills "Company Details Input" as "Test Company" on "Sign Up Page"
              And User fills "Account Details Input" as "Test Account" on "Sign Up Page"
              ...
              And User chooses "Country" as "India" from "Country List" on "Sign Up Page"
              And User chooses "Currency" as "USD" from "Currency List" on "Sign Up Page"
              And User chooses "Industry" as "Home & Garden" from "Industry List" on "Sign Up Page"
